...
description: Une application mobile qui utilise la tokenisation d'actif pour réduire le coût nécessaire pour investir dans l'automobile et vous débarrasser de la paperasse
thumbs:
  [
    {
...
![Architecture de l'information de la version 1 de l'application](../../assets/images/wheel-token/information_architecture.jpg)
...
![Onboarding flow(avec les écrans figma) visant les investisseurs qui n'ont pas de l'expérience avec la crypto](../../assets/images/wheel-token/onboarding_flow.jpg)
